...
export default class FirstPersonCameraOctree extends Camera {
  ...
  setDebugObject(): void {
    ...
    const f = this.debugFolder.addFolder("movements");
    f.add(this, "speed").min(1).max(100).step(0.1);
    f.add(this, "mass").min(0.1).max(5).step(0.1);
  }
}
